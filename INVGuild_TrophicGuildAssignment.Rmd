...
* the file containing the list of invertebrate taxa (formatted like [SILVA](https://www.arb-silva.de/)) to be assigned to a trophic guild in a column named "Taxon". In this case we use the file *Taxonomy_LUCAS_Metazoa.tsv*, that contains the list of invertebrate taxa obtained in the [INVGuild paper](https://www.XXX.xx/) reanalysing the [LUCAS dataset](https://doi.org/10.1111/gcb.16871).
